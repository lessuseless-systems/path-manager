...
in
{
  ...
  config = {
    ...
    # Note: Validation of conflicting declarations is not possible in the HM module
    # due to module system evaluation order. For full conflict detection, use the
    # NixOS module version which operates at the system level.
  };
}
